...
var Model  = ORM.Model.extend({
  initialize: function() {
    console.log('INIT', this.tableName);
  ...
  validateSave: function() {
    console.log('Default validator', this.tableName);
    return true; // TODO
  },
...
var Entity = Geometry.extend({
    ...
    validateSave: function() {
        console.log('validateSave', this.has('user_id') , this.get('user_id') , this.has('layer_id') , this.get('layer_id'));
